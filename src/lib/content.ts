  ...
  return [
    {
      ...
      chapters: [
        ...
        },
        {
          ...
          track: 'spe',
          order: 7,
          description: 'Variables aléatoires, lois usuelles',
          lessons: ['variables-aleatoires', 'loi-binomiale', 'loi-normale'],
        },
      ],
    },
    {
      ...
      chapters: [
        {
          ...
          lessons: ['complexes-introduction', 'complexes-formes', 'complexes-geometrie'],
        },
        {
          id: 'matrices',
          ...
          lessons: ['matrices-operations', 'matrices-systemes'],
        },
        {
          id: 'arithmetique',
          title: 'Arithmétique',
          ...
          lessons: ['divisibilite', 'congruences', 'bezout'],
        },
        {
          id: 'graphes',
          title: 'Graphes',
