      ...
      chapters: [
        {
          ...
          title: 'Notations et ensembles',
          track: 'rappels',
          order: 1,
          description: 'Sommes, ensembles, intervalles et valeur absolue',
          lessons: ['sommes-produits', 'ensembles-intervalles-valeur-absolue'],
        },
        {
          id: 'rappels-algebre',
          title: 'Algèbre express',
          track: 'rappels',
          order: 2,
        ...
        },
        {
          ...
          title: 'Fonctions et trigo',
          track: 'rappels',
          order: 3,
          description: 'Lecture graphique et repères trigonométriques',
          lessons: ['lecture-graphique-fonctions', 'trigonometrie-express'],
        },
      ],
    },
    {
