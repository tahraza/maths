    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-8">
      <div className="mx-auto max-w-3xl px-4">
        ...
        <div className="mb-6">
          <Link
            href="/exercices"
            className="flex items-center gap-2 text-sm text-slate-600 hover:text-primary-600 dark:text-slate-400 dark:hover:text-primary-400 mb-4"
          >
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                {exercise.isComprehension && (
                  <span className="badge bg-cyan-100 text-cyan-700 dark:bg-cyan-900/50 dark:text-cyan-300">
                    Compréhension
                  </span>
                )}
              </div>
          ...
          <div className="card mb-6">
            ...
            <div className="space-y-3">
              {exercise.hints.map((hint, index) => {
                ...
                return (
                  <div key={index} className="rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-900/20">
                    <div className="flex items-center justify-between">
                      ...
                      {!isRevealed ? (
                        <button
                          ...
                          className="flex items-center gap-1 text-sm text-amber-700 hover:text-amber-900 dark:text-amber-400 dark:hover:text-amber-200"
                        >
          ...
          {solutionRevealed ? (
            <div className="space-y-4">
                ...
                >
                  ...
                  {currentStep === index && (
                    <div className="mt-4">
                      ...
                      {step.explanation && (
                        <div className="mt-3 rounded-lg bg-slate-100 p-3 text-sm text-slate-700 dark:bg-slate-700 dark:text-slate-300">
              ...
              {exercise.commonMistakes.length > 0 && (
                <div className="rounded-lg border-l-4 border-danger-500 bg-danger-50 p-4 dark:bg-red-900/20">
                  <h3 className="font-semibold text-danger-900 dark:text-red-200 mb-2 flex items-center gap-2">
                    <AlertTriangle className="h-5 w-5" />
                    Erreurs fréquentes
                  </h3>
                  <ul className="space-y-1 text-danger-800 dark:text-red-300">
