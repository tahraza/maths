...
export default function GuidedExercisesPage() {
  ...
  const exercises = guidedExercisesData.exercises as GuidedExercisePreview[]

  // Get unique themes
  const themes = useMemo(() => {
    const uniqueThemes = new Set(exercises.map(ex => ex.theme))
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex items-center gap-2">
              <Filter className="h-4 w-4 text-slate-500" />
              <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Difficulté :</span>
            </div>
