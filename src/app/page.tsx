  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-slate-900">Deux programmes complets</h2>
            <p className="mx-auto mt-4 max-w-2xl text-slate-600">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            ...
            <div className="card bg-gradient-to-br from-primary-50 to-white border-primary-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-900">Spécialité Maths</h3>
                  <p className="text-sm text-slate-600">{speLessons.length} leçons disponibles</p>
                </div>
              </div>
            ...
            <div className="card bg-gradient-to-br from-purple-50 to-white border-purple-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-900">Maths Expertes</h3>
                  <p className="text-sm text-slate-600">{expertesLessons.length} leçons disponibles</p>
                </div>
              </div>
              <ul className="mt-6 space-y-2">
                <li className="flex items-center gap-2 text-sm text-slate-700">
