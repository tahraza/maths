...
const parcours = [
  {
    ...
    description: 'Parcours intensif pour préparer le bac. Couvre tout le programme de spécialité avec une progression optimisée.',
    duration: '30 jours',
    tracks: ['spe'],
    ...
    color: 'primary',
    features: [
      'Programme complet de spécialité',
  ...
  },
  {
    ...
    description: 'Maîtrise les points difficiles et les subtilités du programme pour viser l\'excellence au bac.',
    duration: '45 jours',
    tracks: ['spe', 'expertes'],
    estimatedDaily: '60-90 min',
    difficulty: 'hard',
    icon: Zap,
    color: 'amber',
    features: [
      'Exercices avancés et type concours',
      'Spécialité + Expertes',
  ...
  },
  {
    ...
    description: 'Parcours dédié aux maths expertes : complexes, matrices, arithmétique et graphes.',
    duration: '25 jours',
    tracks: ['expertes'],
    estimatedDaily: '45-60 min',
    difficulty: 'hard',
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 py-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Active path banner */}
        {activePath && (
          <div className="mb-8 rounded-xl border border-success-200 dark:border-success-800 bg-success-50 dark:bg-success-900/20 p-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="font-semibold text-success-900 dark:text-success-300 flex items-center gap-2">
                  <Play className="h-5 w-5" />
                  Parcours en cours
                </h2>
                <p className="mt-1 text-success-800 dark:text-success-400">
              ...
              >
                  ...
                  <div className="flex items-center gap-1">
                    {p.tracks.map((track) => (
                      <span
                        ...
                        className={cn(
                          'badge text-xs',
                          track === 'spe' ? 'bg-primary-100 text-primary-700' : 'bg-purple-100 text-purple-700'
                        )}
                      >
                        {track === 'spe' ? 'Spé' : 'Exp'}
                      </span>
                ...
                <div className="mt-6">
                  {isActive ? (
                    ...
                    <button
                      disabled
                      className="btn w-full justify-center bg-slate-100 dark:bg-slate-700 text-slate-400 dark:text-slate-500 cursor-not-allowed"
                    >
        ...
        <div className="mt-12 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-8">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div>
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 mb-3">
